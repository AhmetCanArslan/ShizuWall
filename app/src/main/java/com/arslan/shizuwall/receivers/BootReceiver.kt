...
class BootReceiver : BroadcastReceiver() {
    ...
    private fun readStringSet(primary: SharedPreferences, fallback: SharedPreferences?, key: String): Set<String> =
        source(primary, fallback, key)?.getStringSet(key, emptySet()) ?: emptySet()
